...
<hr></hr>
  ...
  <div class="row">
    ...
    <div class="col">
      <motion.img  whileHover={{scale:1.1}} src='formal black.jpg' className='img-thumbnail' style={{borderRadius:"50%",height:'25rem',border:'1rem solid black'}}></motion.img>
    </div>
...
<center><div class="container text-center" style={{color:'lightgreen'}}>
  ...
  <div class="row" >
    <div class="col" >
      <NavLink to='https://bihar-tourism-vicky.netlify.app'><motion.h3  whileHover={{color:'yellow'}} animate={{scale:1.2}} transition={{duration:1 ,repeat:Infinity}} style={{marginTop:'2rem',color:'lightgreen'}}>Bihar Tourism Website</motion.h3></NavLink>
  ...
  <div class="row">
    <div class="col" >
      <NavLink to='https://takcart-my-shopping-app.netlify.app'><motion.h3  whileHover={{color:'yellow'}} animate={{scale:1.2}} transition={{duration:1 ,repeat:Infinity}} style={{marginTop:'2rem',color:'lightgreen'}}>Takcart-a shopping website</motion.h3></NavLink>
  ...
  <div class="row">
    <div class="col" >
     ...
     <NavLink to='https://vicky-touch-typing.netlify.app/'><motion.img whileHover={{scale:1.1}} src='typing web.png' className='img-thumbnail' style={{marginTop:'3rem',height:'20rem'}} alt='....'/></NavLink>
      ...
      <div className="col" style={{marginTop:'1rem'}}>
      <motion.p whileHover={{color:'yellow'}}>This is a touch typing app where you can check your typing accuracy and speed.</motion.p>
    </div>
    </div>
  </div>
