...
<div className="container text-center">
  <div class="row">
    ...
    <div class="row" >
    <div class="col" >
      <NavLink to='https://tourism-web-with-react-by-vicky.vercel.app/'><motion.h3  data-aos="fade-up" data-aos-duration="1500" whileHover={{color:'yellow'}}  transition={{duration:1 ,repeat:Infinity}} style={{marginTop:'2rem',color:'lightgreen'}}>Tourism Website</motion.h3></NavLink>
    ...
    <div class="row">
    <div class="col" >
      <NavLink to='https://typing-web-by-vicky.netlify.app/'><motion.h3  whileHover={{color:'yellow'}} data-aos="fade-up" data-aos-duration="1500" transition={{duration:1 ,repeat:Infinity}} style={{marginTop:'2rem',color:'lightgreen'}}>Typing Website</motion.h3></NavLink>
